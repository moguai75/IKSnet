...
{
    public class BenutzerRolleController : Controller
    {
        internal void AddUserAndRole()
        {
            ...
            if (!roleMgr.RoleExists("IKS-Manager"))
            {
                IdRoleResult = roleMgr.Create(new IdentityRole { Name = "IKS-Manager" });
            }

            if (!roleMgr.RoleExists("Mitarbeiter"))
            {
                IdRoleResult = roleMgr.Create(new IdentityRole { Name = "Mitarbeiter" });
            }
